...
alter table "v1_trackAdd" add column "note"				text ;
alter table "v1_trackAdd" add column "hash"				char varying (100);
alter table "v1_trackAdd" add column "prev_hash"		char varying (100);
...
drop FUNCTION v1_getInfo ( p_tag varchar );
...
BEGIN
	...
	l_fail = false;
	l_data = '{"status":"success","ya":"betcha 001"}';
