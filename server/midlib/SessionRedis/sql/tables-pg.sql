...
CREATE OR REPLACE function t_group_upd()
RETURNS trigger AS 
$BODY$
BEGIN
...
CREATE TRIGGER t_group_trig
BEFORE update ON "t_group"
FOR EACH ROW
EXECUTE PROCEDURE t_group_upd();




CREATE OR REPLACE function t_activity_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_activity_trig
BEFORE update ON "t_activity"
FOR EACH ROW
EXECUTE PROCEDURE t_activity_upd();




CREATE OR REPLACE function t_project_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_project_trig
BEFORE update ON "t_project"
FOR EACH ROW
EXECUTE PROCEDURE t_project_upd();




CREATE OR REPLACE function t_host_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_host_trig
BEFORE update ON "t_host"
FOR EACH ROW
EXECUTE PROCEDURE t_host_upd();




CREATE OR REPLACE function t_host_can_run_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_host_can_run_trig
BEFORE update ON "t_host_can_run"
FOR EACH ROW
EXECUTE PROCEDURE t_host_can_run_upd();




CREATE OR REPLACE function t_host_can_vm_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_host_can_vm_trig
BEFORE update ON "t_host_can_vm"
FOR EACH ROW
EXECUTE PROCEDURE t_host_can_vm_upd();




CREATE OR REPLACE function t_client_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_client_trig
BEFORE update ON "t_client"
FOR EACH ROW
EXECUTE PROCEDURE t_client_upd();




CREATE OR REPLACE function t_a_run_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_a_run_trig
BEFORE update ON "t_a_run"
FOR EACH ROW
EXECUTE PROCEDURE t_a_run_upd();




CREATE OR REPLACE function t_monitor_stuff_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_monitor_stuff_trig
BEFORE update ON "t_monitor_stuff"
FOR EACH ROW
EXECUTE PROCEDURE t_monitor_stuff_upd();




CREATE OR REPLACE function t_status_stuff_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_status_stuff_trig
BEFORE update ON "t_status_stuff"
FOR EACH ROW
EXECUTE PROCEDURE t_status_stuff_upd();




CREATE OR REPLACE function t_ssh_port_pool_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_ssh_port_pool_trig
BEFORE update ON "t_ssh_port_pool"
FOR EACH ROW
EXECUTE PROCEDURE t_ssh_port_pool_upd();




CREATE OR REPLACE function t_ssh_login_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_ssh_login_trig
BEFORE update ON "t_ssh_login"
FOR EACH ROW
EXECUTE PROCEDURE t_ssh_login_upd();




CREATE OR REPLACE function t_ssh_global_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_ssh_global_trig
BEFORE update ON "t_ssh_global"
FOR EACH ROW
EXECUTE PROCEDURE t_ssh_global_upd();




CREATE OR REPLACE function t_it_work_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_it_work_trig
BEFORE update ON "t_it_work"
FOR EACH ROW
EXECUTE PROCEDURE t_it_work_upd();




CREATE OR REPLACE function t_knobs_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_knobs_trig
BEFORE update ON "t_knobs"
FOR EACH ROW
EXECUTE PROCEDURE t_knobs_upd();




CREATE OR REPLACE function t_ua_log_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_ua_log_trig
BEFORE update ON "t_ua_log"
FOR EACH ROW
EXECUTE PROCEDURE t_ua_log_upd();




CREATE OR REPLACE function t_link_valid_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_link_valid_trig
BEFORE update ON "t_link_valid"
FOR EACH ROW
EXECUTE PROCEDURE t_link_valid_upd();
