...
CREATE OR REPLACE function p_uploaded_file_upd()
RETURNS trigger AS 
$BODY$
BEGIN
...
CREATE TRIGGER p_uploaded_file_trig
BEFORE update ON "p_uploaded_file"
FOR EACH ROW
EXECUTE PROCEDURE p_uploaded_file_upd();
