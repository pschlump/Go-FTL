...
CREATE OR REPLACE function t_log_info_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_log_info_trig
BEFORE update ON "t_log_info"
FOR EACH ROW
EXECUTE PROCEDURE t_log_info_upd();
...
CREATE OR REPLACE function t_email_list_upd()
RETURNS trigger AS 
$BODY$
BEGIN
  NEW.updated := current_timestamp;
...
CREATE TRIGGER t_email_list_trig
BEFORE update ON "t_email_list"
FOR EACH ROW
EXECUTE PROCEDURE t_email_list_upd();
